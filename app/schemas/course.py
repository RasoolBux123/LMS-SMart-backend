...
# The admin course dialog offers active / draft / archived, while the older
# coursework code writes "published". All four are accepted so a PATCH from
# the UI is not rejected with a 422.
CourseStatus = Literal["draft", "active", "published", "archived"]
